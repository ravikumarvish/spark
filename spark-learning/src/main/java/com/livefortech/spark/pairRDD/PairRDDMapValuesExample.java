...
public class PairRDDMapValuesExample {
	...
	public static void main(String[] args) {
        ...
        JavaPairRDD<Integer,String> pairRDDSAfterTransformation = pairRDDS.mapValues(line -> line.toUpperCase());
        
        pairRDDSAfterTransformation.saveAsTextFile("out/pairRDDSAfterTransformation");
